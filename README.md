...
|----------------|-----------------|-----|
|  (__[Проект Маркетплейс](https://github.com/SHegor74/project_marketplace)__)|Оценка retention и наличия PMF.   
Определение и расчет ключевых продуктовых метрик продукта.   
Приоритезация гипотез с помощью ICE. 
  Определение метрик, на которые повлияет реализация выбранной гипотезы.|pandas, numpy, parser, matplotlib, seaborn|
